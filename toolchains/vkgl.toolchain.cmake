...
add_definitions(-DFE_TOWARDZERO=0x00c00000)
...
set(PROJECT_ROOT /home/zhangsz/OpenHarmony_master_0625)


#指定c编译工具（确保工具链所在路径已经添加到了PATH环境变量中）和编译标志，使用clang编译时标志中必须指定--target，否则无法交叉编译。
set(CMAKE_C_COMPILER ${PROJECT_ROOT}/prebuilts/clang/ohos/linux-x86_64/llvm/bin/clang)
...
set(CMAKE_CXX_COMPILER ${PROJECT_ROOT}/prebuilts/clang/ohos/linux-x86_64/llvm/bin/clang++) 
...
set(MY_LINK_FLAGS "--target=arm-linux-ohosmusl --sysroot=${PROJECT_ROOT}/out/rk3568/obj/third_party/musl/")
set(CMAKE_LINKER ${PROJECT_ROOT}/prebuilts/clang/ohos/linux-x86_64/llvm/bin/clang)
set(CMAKE_CXX_LINKER ${PROJECT_ROOT}/prebuilts/clang/ohos/linux-x86_64/llvm/bin/clang++)
set(CMAKE_C_LINKER ${PROJECT_ROOT}/prebuilts/clang/ohos/linux-x86_64/llvm/bin/clang)
