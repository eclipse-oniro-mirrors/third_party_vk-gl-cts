...
#include "generated/vulkan/vkConcretePlatformInterface.inl"
...
protected:
    struct Functions
    {
#include "generated/vulkan/vkPlatformFunctionPointers.inl"
    };
...
#include "generated/vulkan/vkConcreteInstanceInterface.inl"
...
protected:
    ...
    struct Functions
    {
#include "generated/vulkan/vkInstanceFunctionPointers.inl"
    };
...
#include "generated/vulkan/vkConcreteDeviceInterface.inl"
...
protected:
    struct Functions
    {
#include "generated/vulkan/vkDeviceFunctionPointers.inl"
    };
...
public:
    DeviceDriverSC(const PlatformInterface &platformInterface, VkInstance instance, VkDevice device,
                   ...
                   const VkPhysicalDeviceProperties &physicalDeviceProperties, const uint32_t usedApiVersion);
