...
template<> VkStructureType getStructureType<VkNativeBufferOpenHarmony> (void)
{
	return VK_STRUCTURE_TYPE_NATIVE_BUFFER_OPENHARMONY;
}

template<> VkStructureType getStructureType<VkSwapchainImageCreateInfoOpenHarmony> (void)
{
	return VK_STRUCTURE_TYPE_SWAPCHAIN_IMAGE_CREATE_INFO_OPENHARMONY;
}

template<> VkStructureType getStructureType<VkPhysicalDevicePresentationPropertiesOpenHarmony> (void)
{
	return VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENTATION_PROPERTIES_OPENHARMONY;
}
