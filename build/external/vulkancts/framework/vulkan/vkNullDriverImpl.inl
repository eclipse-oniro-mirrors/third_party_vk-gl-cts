...
VKAPI_ATTR VkResult VKAPI_CALL getSwapchainGrallocUsageOpenHarmony (VkDevice device, VkFormat format, VkImageUsageFlags imageUsage, int* grallocUsage)
{
	DE_UNREF(device);
	DE_UNREF(format);
	DE_UNREF(imageUsage);
...
VKAPI_ATTR VkResult VKAPI_CALL setNativeFenceFdOpenHarmony (VkDevice device, int32_t nativeFenceFd, VkSemaphore semaphore, VkFence fence)
{
	DE_UNREF(device);
...
VKAPI_ATTR VkResult VKAPI_CALL getNativeFenceFdOpenHarmony (VkQueue queue, uint32_t waitSemaphoreCount, const VkSemaphore* pWaitSemaphores, VkImage image, int32_t* pNativeFenceFd)
{
	DE_UNREF(queue);
...
static const tcu::StaticFunctionLibrary::Entry s_deviceFunctions[] =
{
	...
	VK_NULL_FUNC_ENTRY(vkGetSwapchainGrallocUsageOpenHarmony,						getSwapchainGrallocUsageOpenHarmony),
	VK_NULL_FUNC_ENTRY(vkSetNativeFenceFdOpenHarmony,								setNativeFenceFdOpenHarmony),
	VK_NULL_FUNC_ENTRY(vkGetNativeFenceFdOpenHarmony,								getNativeFenceFdOpenHarmony),
