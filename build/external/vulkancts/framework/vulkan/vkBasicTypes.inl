...
enum VkSwapchainImageUsageFlagBitsOpenHarmony
{
	VK_SWAPCHAIN_IMAGE_USAGE_SHARED_BIT_OPENHARMONY				= 0x00000001,
	VK_SWAPCHAIN_IMAGE_USAGE_FLAG_BITS_OPEN_HARMONY_MAX_ENUM	= 0x7FFFFFFF
};
...
typedef uint32_t VkOHOSSurfaceCreateFlagsOpenHarmony;
...
typedef uint32_t VkSwapchainImageUsageFlagsOpenHarmony;
