...
DE_DECLARE_COMMAND_LINE_OPT(GLV4,                       bool);
...
void registerOptions (de::cmdline::Parser& parser)
{
	...
	parser
		...
		<< Option<GLV4>							(DE_NULL,   "deqp-glv4",               "Enable or disable glv4 context",                   s_enableNames,      "disable");  
}
...
bool					CommandLine::isGLV4Enabled					(void) const	{ return m_cmdLine.getOption<opt::GLV4>();									}
